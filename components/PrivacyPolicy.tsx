    ...
    <div className="fixed inset-0 z-[2000] bg-slate-900/60 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-300" onClick={onClose}>
      ...
      >
        ...
        <div className="p-8 overflow-y-auto prose prose-slate max-w-none">
            ...
            <p>Last updated: December 07, 2025</p>
            ...
            <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Creative Space.</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>Website</strong> refers to Creative Space, accessible from <a href="https://creative-space-rtk7.vercel.app/" rel="external nofollow noopener noreferrer" target="_blank">https://creative-space-rtk7.vercel.app/</a></p>
            </li>
            <li>
            ...
            <ul>
            <li>By email: efadsani5540@gmail.com</li>
            </ul>
        </div>
      </div>
    </div>
